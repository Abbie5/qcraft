...
public class Blocks {
    ...
    public static final Block QUANTUM_DUST_BLOCK = new Block(FabricBlockSettings.of().luminance(1).strength(1.0f));
    ...
    public static void register(String name, Block block) {
        Registry.register(Registries.BLOCK, QCraft.id(name), block);
